...
> Άνοιγμα αυτής της σελίδας στο [https://mogloukos.github.io/maqueen01/](https://mogloukos.github.io/maqueen01/)
...
* αναζήτηση για **https://github.com/mogloukos/maqueen01** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/mogloukos/maqueen01/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/mogloukos/maqueen01** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/mogloukos/maqueen01/raw/master/.github/makecode/blocks.png)
